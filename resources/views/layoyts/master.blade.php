                ...
                <div class="row">
                    <div class="col-md-2 d-flex">
                        <div class="logo align-self-center">
                            <a href="index-2.html"><img class="img-responsive" src="assets/images/logo/logo.png"
                                    alt="logo.jpg" /></a>
                        </div>
                    </div>
                            ...
                            <article class="list-product text-center">
                                <div class="product-inner">
                                    ...
                                    <div class="product-decs">
                                        ...
                                        <h2><a href="single-product.html" class="product-link">Naham WiFi HD 1080P</a>
                                        </h2>
                                        <div class="pricing-meta">
                                            <ul>
                                                <li class="current-price">$21.51</li>
                        ...
                        <div class="slider-single-item">
                            ...
                            <article class="list-product text-center">
                                <div class="product-inner">
                                    ...
                                    <div class="product-decs">
                                        <a class="inner-link" href="shop-4-column.html"><span>GRAPHIC CORNER</span></a>
                                        <h2><a href="single-product.html" class="product-link">Polk Audio T30
                                                Speaker</a></h2>
                                        <div class="pricing-meta">
                                            <ul>
                                                <li class="current-price">$21.51</li>
                        ...
                        <div class="slider-single-item">
                            ...
                            <article class="list-product text-center">
                                <div class="product-inner">
                                    ...
                                    <div class="product-decs">
                                        <a class="inner-link" href="shop-4-column.html"><span>STUDIO DESIGN</span></a>
                                        <h2><a href="single-product.html" class="product-link">TCL 49S5 49” 4K Ultra
                                                HD</a></h2>
                                        <div class="pricing-meta">
                                            <ul>
                                                <li class="current-price">$21.51</li>
                        ...
                        <div class="slider-single-item">
                            ...
                            <article class="list-product text-center">
                                <div class="product-inner">
                                    ...
                                    <div class="availability-list in-stock">Availability: <span>300 In Stock</span>
                                    </div>
                                    <div class="clockdiv">
                    ...
                    <article class="list-product text-center">
                        <div class="product-inner">
                            ...
                            <div class="product-decs">
                                ...
                                <p>Android 8.1 (Oreo), Hisilicon Kirin 710 (12 nm), Octa-core (4x2.2 GHz Cortex-A73
                                    &amp; 4x1.7 GHz Cortex-A53), Mali-G51 MP4</p>
                                <div class="pricing-meta">
                                    <ul>
                    ...
                    <article class="list-product text-center">
                        <div class="product-inner">
                            ...
                            <div class="product-decs">
                                ...
                                <p>Dimensions (W x H x D): TV without stand: 43.7" x 25.3" x 3", TV with stand: 43.7" x
                                    27.7" x 8.5"</p>
                                <div class="pricing-meta">
                                    <ul>
                                        <li class="old-price">$21.51</li>
        ...
        <div class="container">
            <div class="brand-slider">
                <div class="brand-slider-item">
                    <a href="#"><img class=" img-responsive" src="assets/images/brand-logo/1.png" alt="" /></a>
                </div>
                <div class="brand-slider-item">
                    <a href="#"><img class=" img-responsive" src="assets/images/brand-logo/2.png" alt="" /></a>
                </div>
                <div class="brand-slider-item">
                    <a href="#"><img class=" img-responsive" src="assets/images/brand-logo/3.png" alt="" /></a>
                </div>
                <div class="brand-slider-item">
                    <a href="#"><img class=" img-responsive" src="assets/images/brand-logo/4.png" alt="" /></a>
                </div>
                <div class="brand-slider-item">
                    <a href="#"><img class=" img-responsive" src="assets/images/brand-logo/5.png" alt="" /></a>
                </div>
                <div class="brand-slider-item">
                    <a href="#"><img class=" img-responsive" src="assets/images/brand-logo/1.png" alt="" /></a>
                </div>
                        ...
                        <div class="col-md-6 col-lg-4 mb-md-30px mb-lm-30px">
                            <div class="single-wedge">
                                ...
                                <p class="text-infor">We are a team of designers and developers that create high quality
                                    HTML template</p>
                                <div class="need_help">
                                    <p class="add"><span class="address">Address:</span> 4710-4890 Breckinridge St,
                                        Fayetteville</p>
                                    <p class="mail"><span class="email">Email:</span> <a
                                            href="mailto:support@hasthemes.com">support@hasthemes.com</a></p>
                                    <p class="phone"><span class="call us">Call Us:</span> <a
                                            href="tel:(+800)123456789"> (+800)123456789</a></p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="footer-blog-slider-wrapper slider-nav-style-3 ">
                                        ...
                                        <div class="single-slider-item">
                                            <div class="footer-blog-post d-flex mb-30px">
                                                ...
                                                <div class="footer-blog-content">
                                                    <h4><a href="blog-single-left-sidebar.html">This is First Post For
                                                            XipBlog</a></h4>
                                                    <div class="footer-blog-meta">
                                                        <span class="autor">Posted by <a href="#">Demo Hasthemes</a>
                                                        </span>
                                            ...
                                            <div class="footer-blog-post">
                                                ...
                                                <div class="footer-blog-content">
                                                    <h4><a href="blog-single-left-sidebar.html">This is Secound Post For
                                                            XipBlog</a></h4>
                                                    <div class="footer-blog-meta">
                                                        <span class="autor">Posted by <a href="#">Demo Hasthemes</a>
                                                        </span>
                                        ...
                                        <div class="single-slider-item">
                                            <div class="footer-blog-post d-flex mb-30px">
                                                ...
                                                <div class="footer-blog-content">
                                                    <h4><a href="blog-single-left-sidebar.html">This is Third Post For
                                                            XipBlog</a></h4>
                                                    <div class="footer-blog-meta">
                                                        <span class="autor">Posted by <a href="#">Demo Hasthemes</a>
                                                        </span>
                                            ...
                                            <div class="footer-blog-post d-flex">
                                                ...
                                                <div class="footer-blog-content">
                                                    <h4><a href="blog-single-left-sidebar.html">This is Fourth Post For
                                                            XipBlog</a></h4>
                                                    <div class="footer-blog-meta">
                                                        <span class="autor">Posted by <a href="#">Demo Hasthemes</a>
                                                        </span>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="footer-paymet-warp d-flex">
                                ...
                                <div class="payment-way"><img class="payment-img img-responsive"
                                        src="assets/images/icons/payment.png" alt="" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
